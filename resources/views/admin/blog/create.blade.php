...
<div class="card dark:bg-slate-800 dark:border-slate-700 overflow-hidden p-6">
    <form action="{{ route('admin.blog.store') }}" method="POST" class="no-confirm">
        @csrf
        ...
        <div class="mb-5" x-ignore>
            ...
            <textarea id="content" name="content" class="w-full px-4 py-2.5 border border-slate-200 dark:border-slate-700 rounded-xl text-sm min-h-[300px]">{{ old('content') }}</textarea>
        ...
        <div class="mb-6 flex items-center gap-3">
            ...
            <label for="is_published" class="text-sm font-bold text-slate-700 dark:text-slate-300 cursor-pointer">Publicar imediatamente</label>
        </div>
